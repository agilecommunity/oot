...
public class JodaDateOperator {

    private static final String PATTERN = "yyyy-MM-ddZ";

    public static class JodaDateDeserializer extends JsonDeserializer<DateTime> {
        @Override
    ...
    public static class JodaDateSerializer extends JsonSerializer<DateTime> {
        @Override
