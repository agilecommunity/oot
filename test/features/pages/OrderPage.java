...
public class OrderPage {
    ...
    public void order(DateTime orderDate, String shopName, String itemName, String priceOnOrder) throws Throwable {
        ...
        By itemLocator = By.xpath(String.format("//div[contains(@class, 'menu-item-list')]//div[contains(@class,'menu-item')]//div[@class='caption' and div[contains(@class,'shop-name') and text()='%s'] and div[contains(@class, 'food-name') and text()='%s'] and div[contains(@class, 'food-price') and span/span[text()='%s']]]", shopName, itemName, priceOnOrder));
        SeleniumUtils.waitAndClick(this.driver, itemLocator);

        By orderdItemLocator = By.xpath(String.format("//div[@id='day-%s']//div[contains(@class, 'menu-item-list')]//div[contains(@class,'menu-item') and contains(@class, 'ordered')]//div[@class='caption' and div[contains(@class,'shop-name') and text()='%s'] and div[contains(@class, 'food-name') and text()='%s'] and div[contains(@class, 'food-price') and span/span[text()='%s']]]", orderDate.toString("yyyyMMdd"), shopName, itemName, priceOnOrder));
