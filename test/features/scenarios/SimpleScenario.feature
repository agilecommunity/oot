  ...
  シナリオ: 商品登録から注文までの基本的な流れ
    ...
    もし    ユーザ "admin@localhost" パスワード "adminadmin" でサインインする
      ...
      かつ  以下の内容のメニューを作成する:
        ...
        | 商品-2     | 弁当　渋谷肉屋　生姜焼き弁当　600円           |
        | 商品-3     | サイドメニュー　新宿果物屋　バナナ　150円     |
    ...
    # 氏名は、左側の商品から順に、商品を買った人ごとに表示されていること
    # 同じ商品を買った人は、氏名の昇順で表示されていること
    もし    ユーザ "admin@localhost" パスワード "adminadmin" でサインインする
    ならば  日付 "2014/12/09" のチェック表の総額が "1,900円" かつ、以下の内容であること:
        | チェック | 氏名                        | 渋谷肉屋　生姜焼き弁当　600円 | 銀座魚屋　鯛茶漬け　500円 | 新宿果物屋　バナナ　150円     | 新宿果物屋　マンゴー　300円 |
        |          | ポッペンディーク メアリー   | ○                            |                           |                               |                             |
        |          | クニベルグ ヘンリック       |                               | ○                        | ○                            |                             |
        |          | ポッペンディーク トム       |                               | ○                        | ○                            |                             |
